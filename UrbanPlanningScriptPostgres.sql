...
-- Started on 2024-01-29 16:50:00
...
--
-- TOC entry 4985 (class 1262 OID 16840)
...
-- Name: check_estate; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.check_estate (
    id_check_estate integer NOT NULL,
...
-- Name: check_estate_id_check_estate_seq; Type: SEQUENCE; Schema: public; Owner: -
--

ALTER TABLE public.check_estate ALTER COLUMN id_check_estate ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME public.check_estate_id_check_estate_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- TOC entry 242 (class 1259 OID 16939)
...
--
-- TOC entry 241 (class 1259 OID 16938)
...
-- Name: layout_photo; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.layout_photo (
    id_layout_photo integer NOT NULL,
...
-- Name: layout_photo_id_layout_photo_seq; Type: SEQUENCE; Schema: public; Owner: -
--

ALTER TABLE public.layout_photo ALTER COLUMN id_layout_photo ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME public.layout_photo_id_layout_photo_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- TOC entry 244 (class 1259 OID 16945)
-- Name: layout_photo_layout_estate; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.layout_photo_layout_estate (
    id_layout_photo_layout_estate integer NOT NULL,
    id_layout_estate integer NOT NULL,
    id_layout_photo integer NOT NULL
);
...
-- Name: layout_photo_layout_estate_id_layout_photo_layout_estate_seq; Type: SEQUENCE; Schema: public; Owner: -
--

ALTER TABLE public.layout_photo_layout_estate ALTER COLUMN id_layout_photo_layout_estate ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME public.layout_photo_layout_estate_id_layout_photo_layout_estate_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- TOC entry 4973 (class 0 OID 16925)
-- Dependencies: 238
...
--
-- TOC entry 4975 (class 0 OID 16933)
-- Dependencies: 240
-- Data for Name: check_estate; Type: TABLE DATA; Schema: public; Owner: -
--



--
-- TOC entry 4971 (class 0 OID 16919)
-- Dependencies: 236
...
--
-- TOC entry 4967 (class 0 OID 16907)
-- Dependencies: 232
...
--
-- TOC entry 4955 (class 0 OID 16854)
-- Dependencies: 220
...
--
-- TOC entry 4953 (class 0 OID 16846)
-- Dependencies: 218
...
--
-- TOC entry 4957 (class 0 OID 16860)
-- Dependencies: 222
...
--
-- TOC entry 4977 (class 0 OID 16939)
-- Dependencies: 242
...
--
-- TOC entry 4969 (class 0 OID 16913)
-- Dependencies: 234
...
--
-- TOC entry 4961 (class 0 OID 16887)
-- Dependencies: 226
...
--
-- TOC entry 4959 (class 0 OID 16881)
-- Dependencies: 224
-- Data for Name: layout_photo; Type: TABLE DATA; Schema: public; Owner: -
--



--
-- TOC entry 4979 (class 0 OID 16945)
-- Dependencies: 244
-- Data for Name: layout_photo_layout_estate; Type: TABLE DATA; Schema: public; Owner: -
--



--
-- TOC entry 4965 (class 0 OID 16901)
-- Dependencies: 230
...
--
-- TOC entry 4963 (class 0 OID 16895)
-- Dependencies: 228
...
--
-- TOC entry 4951 (class 0 OID 16842)
-- Dependencies: 216
...
-- Dependencies: 239
-- Name: check_estate_id_check_estate_seq; Type: SEQUENCE SET; Schema: public; Owner: -
--

SELECT pg_catalog.setval('public.check_estate_id_check_estate_seq', 1, false);
...
-- Dependencies: 223
-- Name: layout_photo_id_layout_photo_seq; Type: SEQUENCE SET; Schema: public; Owner: -
--

SELECT pg_catalog.setval('public.layout_photo_id_layout_photo_seq', 1, false);


--
-- TOC entry 4998 (class 0 OID 0)
-- Dependencies: 243
-- Name: layout_photo_layout_estate_id_layout_photo_layout_estate_seq; Type: SEQUENCE SET; Schema: public; Owner: -
--

SELECT pg_catalog.setval('public.layout_photo_layout_estate_id_layout_photo_layout_estate_seq', 1, false);
...
--
-- TOC entry 4784 (class 2606 OID 16937)
-- Name: check_estate check_estate_pk; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.check_estate
    ADD CONSTRAINT check_estate_pk PRIMARY KEY (id_check_estate);


--
-- TOC entry 4782 (class 2606 OID 16929)
...
--
-- TOC entry 4780 (class 2606 OID 16923)
...
--
-- TOC entry 4776 (class 2606 OID 16911)
...
--
-- TOC entry 4764 (class 2606 OID 16858)
...
--
-- TOC entry 4766 (class 2606 OID 16864)
...
--
-- TOC entry 4786 (class 2606 OID 16943)
...
--
-- TOC entry 4778 (class 2606 OID 16917)
...
--
-- TOC entry 4770 (class 2606 OID 16893)
...
--
-- TOC entry 4788 (class 2606 OID 16949)
-- Name: layout_photo_layout_estate layout_photo_layout_estate_pk; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.layout_photo_layout_estate
    ADD CONSTRAINT layout_photo_layout_estate_pk PRIMARY KEY (id_layout_photo_layout_estate);


--
-- TOC entry 4768 (class 2606 OID 16885)
-- Name: layout_photo layout_photo_pk; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.layout_photo
    ADD CONSTRAINT layout_photo_pk PRIMARY KEY (id_layout_photo);


--
-- TOC entry 4772 (class 2606 OID 16899)
...
--
-- TOC entry 4774 (class 2606 OID 16905)
...
--
-- TOC entry 4760 (class 2606 OID 16852)
...
--
-- TOC entry 4801 (class 2606 OID 17025)
...
--
-- TOC entry 4802 (class 2606 OID 17030)
...
--
-- TOC entry 4803 (class 2606 OID 17035)
-- Name: check_estate check_estate_check_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.check_estate
    ADD CONSTRAINT check_estate_check_fk FOREIGN KEY (id_check) REFERENCES public."check"(id_check);


--
-- TOC entry 4804 (class 2606 OID 17040)
-- Name: check_estate check_estate_estate_object_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.check_estate
    ADD CONSTRAINT check_estate_estate_object_fk FOREIGN KEY (id_estate_object) REFERENCES public.estate_object(id_estate_object);


--
-- TOC entry 4800 (class 2606 OID 17010)
...
--
-- TOC entry 4798 (class 2606 OID 17020)
...
--
-- TOC entry 4799 (class 2606 OID 17015)
...
--
-- TOC entry 4791 (class 2606 OID 16965)
...
--
-- TOC entry 4792 (class 2606 OID 16970)
...
--
-- TOC entry 4793 (class 2606 OID 16955)
...
--
-- TOC entry 4794 (class 2606 OID 16960)
...
--
-- TOC entry 4789 (class 2606 OID 16985)
...
--
-- TOC entry 4790 (class 2606 OID 16990)
...
--
-- TOC entry 4795 (class 2606 OID 16975)
...
--
-- TOC entry 4796 (class 2606 OID 16980)
...
--
-- TOC entry 4797 (class 2606 OID 17005)
...
--
-- TOC entry 4805 (class 2606 OID 17000)
-- Name: layout_photo_layout_estate layout_photo_layout_estate_layout_estate_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.layout_photo_layout_estate
    ADD CONSTRAINT layout_photo_layout_estate_layout_estate_fk FOREIGN KEY (id_layout_estate) REFERENCES public.layout_estate(id_layout_estate);


--
-- TOC entry 4806 (class 2606 OID 16995)
-- Name: layout_photo_layout_estate layout_photo_layout_estate_layout_photo_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.layout_photo_layout_estate
    ADD CONSTRAINT layout_photo_layout_estate_layout_photo_fk FOREIGN KEY (id_layout_photo) REFERENCES public.layout_photo(id_layout_photo);


-- Completed on 2024-01-29 16:50:00
