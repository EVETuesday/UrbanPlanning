...
-- Started on 2024-02-21 00:10:25
...
--
-- TOC entry 4983 (class 1262 OID 17584)
...
--
-- TOC entry 256 (class 1255 OID 17851)
...
--
-- TOC entry 242 (class 1255 OID 17849)
...
--
-- TOC entry 257 (class 1255 OID 17885)
...
--
-- TOC entry 254 (class 1255 OID 17841)
...
--
-- TOC entry 255 (class 1255 OID 17842)
...
--
-- TOC entry 260 (class 1255 OID 17941)
-- Name: tr_auto_full_cost(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.tr_auto_full_cost() RETURNS trigger
    LANGUAGE plpgsql
    AS $$
BEGIN
...
--
-- TOC entry 259 (class 1255 OID 17904)
...
--
-- TOC entry 261 (class 1255 OID 17907)
...
--
-- TOC entry 240 (class 1259 OID 17948)
...
--
-- TOC entry 238 (class 1259 OID 17910)
...
--
-- TOC entry 239 (class 1259 OID 17913)
...
--
-- TOC entry 233 (class 1259 OID 17757)
...
--
-- TOC entry 227 (class 1259 OID 17629)
...
--
-- TOC entry 230 (class 1259 OID 17636)
...
--
-- TOC entry 231 (class 1259 OID 17637)
...
--
-- TOC entry 236 (class 1259 OID 17830)
...
CREATE VIEW public.vw_builds AS
 SELECT e.id_estate_object,
    ...
    t.title,
    f.format_title,
    string_agg(concat(fr.id_flat_estate, ''), ', '::text) AS flats
...
--
-- TOC entry 237 (class 1259 OID 17836)
...
CREATE VIEW public.vw_places AS
 SELECT e.id_estate_object,
    ...
    t.title,
    f.format_title,
    string_agg(concat(er.id_building_estate, ''), ', '::text) AS builds
   FROM ((((public.estate_object e
     JOIN public.post_index p ON ((e.id_postindex = p.id_post_index)))
     JOIN public.type_of_activity t ON ((t.id_type_of_activity = e.id_type_of_activity)))
     JOIN public.format f ON ((e.id_format = f.id_format)))
...
--
-- TOC entry 4976 (class 0 OID 17948)
-- Dependencies: 240
...
INSERT INTO public."check" VALUES (52, '2024-02-20 00:00:00', 22440000.00, 1, 1, 1);


--
-- TOC entry 4974 (class 0 OID 17910)
-- Dependencies: 238
...
--
-- TOC entry 4954 (class 0 OID 17593)
-- Dependencies: 215
...
--
-- TOC entry 4972 (class 0 OID 17757)
-- Dependencies: 233
...
--
-- TOC entry 4956 (class 0 OID 17601)
-- Dependencies: 217
...
--
-- TOC entry 4958 (class 0 OID 17607)
-- Dependencies: 219
...
--
-- TOC entry 4960 (class 0 OID 17611)
-- Dependencies: 221
...
--
-- TOC entry 4962 (class 0 OID 17615)
-- Dependencies: 223
...
--
-- TOC entry 4964 (class 0 OID 17619)
-- Dependencies: 225
...
--
-- TOC entry 4966 (class 0 OID 17629)
-- Dependencies: 227
...
--
-- TOC entry 4970 (class 0 OID 17637)
-- Dependencies: 231
...
SELECT pg_catalog.setval('public.check_id_check_seq', 52, true);
...
--
-- TOC entry 4788 (class 2606 OID 17953)
...
--
-- TOC entry 4786 (class 2606 OID 17915)
...
--
-- TOC entry 4766 (class 2606 OID 17646)
...
--
-- TOC entry 4784 (class 2606 OID 17764)
...
--
-- TOC entry 4768 (class 2606 OID 17650)
...
--
-- TOC entry 4770 (class 2606 OID 17652)
...
--
-- TOC entry 4772 (class 2606 OID 17654)
...
--
-- TOC entry 4774 (class 2606 OID 17656)
...
--
-- TOC entry 4776 (class 2606 OID 17658)
...
--
-- TOC entry 4780 (class 2606 OID 17662)
...
--
-- TOC entry 4778 (class 2606 OID 17664)
...
--
-- TOC entry 4782 (class 2606 OID 17666)
...
--
-- TOC entry 4807 (class 2620 OID 17969)
-- Name: check tr_auto_full_cost; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER tr_auto_full_cost BEFORE INSERT ON public."check" FOR EACH ROW EXECUTE FUNCTION public.tr_auto_full_cost();


--
-- TOC entry 4805 (class 2620 OID 17906)
...
--
-- TOC entry 4804 (class 2620 OID 17900)
...
--
-- TOC entry 4806 (class 2620 OID 17932)
...
--
-- TOC entry 4801 (class 2606 OID 17954)
...
--
-- TOC entry 4802 (class 2606 OID 17964)
...
--
-- TOC entry 4803 (class 2606 OID 17959)
...
--
-- TOC entry 4800 (class 2606 OID 17916)
...
--
-- TOC entry 4789 (class 2606 OID 17687)
...
--
-- TOC entry 4790 (class 2606 OID 17692)
...
--
-- TOC entry 4798 (class 2606 OID 17790)
...
--
-- TOC entry 4799 (class 2606 OID 17795)
...
--
-- TOC entry 4791 (class 2606 OID 17934)
...
--
-- TOC entry 4792 (class 2606 OID 17800)
...
--
-- TOC entry 4793 (class 2606 OID 17805)
...
--
-- TOC entry 4794 (class 2606 OID 17810)
...
--
-- TOC entry 4795 (class 2606 OID 17815)
...
--
-- TOC entry 4796 (class 2606 OID 17820)
...
-- Completed on 2024-02-21 00:10:26
